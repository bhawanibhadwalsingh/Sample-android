...
//             reqEntity.addPart("phone", new StringBody("9816556215"));
//             reqEntity.addPart("prod_title", new StringBody("bhawani"));
//             reqEntity.addPart("prod_price", new StringBody("25k"));
//             reqEntity.addPart("prod_desc", new StringBody("looking for new job"));
